...
#define CCIWHT(ch,lvl)  (clr((ch),(lvl))?KIWHT:KNUL)
#define CCIBLK(ch,lvl)  (clr((ch),(lvl))?KIBLK:KNUL)
...
#define CCMANA(ch,C_SPR,perc) (perc >=80 ? CCICYN(ch,C_SPR)  :\
                               perc >=50 ? CCCYN(ch,C_SPR) :\
                               perc >=10 ? CCIBLU(ch,C_SPR) :\
                               CCBLU(ch,C_SPR))
#define CCMOVE(ch,C_SPR,perc) (perc >=80 ? CCGRN(ch,C_SPR)  :\
                               perc >=50 ? CCIGRN(ch,C_SPR)  :\
                               perc >=30 ? CCIYEL(ch,C_SPR)  :\
                               perc >=10 ? CCIRED(ch,C_SPR) :\
                               CCRED(ch,C_SPR))


#define CCHIT(ch,C_SPR,perc) (perc >=80 ? CCGRN(ch,C_SPR)  :\
                              perc >=50 ? CCIGRN(ch,C_SPR)  :\
                              perc >=30 ? CCIYEL(ch,C_SPR)  :\
                              perc >=10 ? CCIRED(ch,C_SPR) :\
                              CCRED(ch,C_SPR))
